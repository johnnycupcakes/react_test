...
var _HelloSignEmbedded = __webpack_require__(28);

var _HelloSignEmbedded2 = _interopRequireDefault(_HelloSignEmbedded);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_reactDom2.default.render(_react2.default.createElement(_HelloSignEmbedded2.default, {
    clientId: '44adc0a3f5f6b105ca6386e164d1e87a',
    uxVersion: 2,
    url: 'https://app.hellosign.com/editor/embeddedSign?signature_id=fcc134ae13b94c12de1d8b310b55f58e&token=c79d7f47e62656d109f479d72b1a1006',
    inContainer: true
...
*/
var ba=__webpack_require__(4),m=__webpack_require__(10),A=__webpack_require__(2),C=__webpack_require__(1),ea=__webpack_require__(11),fa=__webpack_require__(12),ha=__webpack_require__(13),ja=__webpack_require__(5);
...
var HS_CONTAINER_ID = "hellosign-embedded";

var HelloSignEmbedded = function (_React$Component) {
    _inherits(HelloSignEmbedded, _React$Component);

    function HelloSignEmbedded(props) {
        _classCallCheck(this, HelloSignEmbedded);

        var _this = _possibleConstructorReturn(this, (HelloSignEmbedded.__proto__ || Object.getPrototypeOf(HelloSignEmbedded)).call(this, props));

        _this.getHsSettings = _this.getHsSettings.bind(_this);
        return _this;
    }

    _createClass(HelloSignEmbedded, [{
        ...
        value: function componentDidMount() {
            ...
            if (!window.HelloSign) {
                ...
                script.onload = function () {
                    window.HelloSign.init(_this2.props.clientId);
        ...
        value: function getHsSettings() {
            ...
            // Optional settings
            if (this.props.userCulture) {
                hs_settings.userCulture = this.props.userCulture;
            }
            if (this.props.redirectUrl) {
                hs_settings.redirectUrl = this.props.redirectUrl;
            }
            if (this.props.messageListener) {
                hs_settings.messageListener = this.props.messageListener;
            }
            if (this.props.height) {
                hs_settings.height = this.props.height;
            }
        ...
        value: function render() {
            var container = this.props.inContainer ? _react2.default.createElement('div', { id: HS_CONTAINER_ID }) : "";
    ...
    return HelloSignEmbedded;
}(_react2.default.Component);

HelloSignEmbedded.propTypes = {
    clientId: _propTypes2.default.string.isRequired,
    uxVersion: _propTypes2.default.number.isRequired,
    url: _propTypes2.default.string.isRequired,
    userCulture: _propTypes2.default.string,
    redirectUrl: _propTypes2.default.string,
    allowCancel: _propTypes2.default.bool,
    messageListener: _propTypes2.default.func,
    debug: _propTypes2.default.bool,
    skipDomainVerification: _propTypes2.default.bool,
...
exports.default = HelloSignEmbedded;
